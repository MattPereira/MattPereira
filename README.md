...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,py,solidity,tailwind,nextjs,nodejs,express,postgres,django,vercel,linux,materialui,bash,git,docker)](https://skillicons.dev)
